...
namespace EzySlice
{
    ...
    public sealed class SlicedHull
    {
        ...
        public GameObject CreateUpperHull(GameObject original, GameObject prefab)
        {
            return CreateUpperHull(original, null, prefab);
        }

        public GameObject CreateUpperHull(GameObject original, Material crossSectionMat, GameObject prefab)
        {
            GameObject newObject = CreateUpperHull(prefab);
            if (newObject != null)
            {
        ...
        public GameObject CreateLowerHull(GameObject original, GameObject prefab)
        {
            return CreateLowerHull(original, null, prefab);
        }

        public GameObject CreateLowerHull(GameObject original, Material crossSectionMat, GameObject prefab)
        {
            GameObject newObject = CreateLowerHull(prefab);
        ...
        public GameObject CreateUpperHull(GameObject prefab)
        {
            return CreateEmptyObject("Upper_Hull", upper_hull, prefab);
        }
        ...
        public GameObject CreateLowerHull(GameObject prefab)
        {
            return CreateEmptyObject("Lower_Hull", lower_hull, prefab);
        }
        ...
        private static GameObject CreateEmptyObject(string name, Mesh hull, GameObject prefab)
        {
            if (hull == null)
            {
                return null;
